  ...
  return (
    <html lang="en">
      <body className={cn("dark relative min-h-screen", inter.className)}>
        <div className="absolute left-4 top-8 z-50 translate-x-4 transition-transform duration-200 ease-out [.nav-open_&]:translate-x-0">
          <NavigationToggle />
        </div>
        <Flex className="navigation-surface absolute inset-0 hidden min-h-screen sm:flex">
          <Flex className="flex-[0_1_256px] opacity-0 transition-opacity duration-200 ease-out [.nav-open_&]:opacity-100">
        ...
        <Flex className="content-surface pointer-events-none absolute inset-0 max-h-screen overflow-hidden p-2 md:p-4">
          <Flex className="pointer-events-none min-h-full min-w-0 flex-[0_1_0px] transition-flex duration-200 ease-out will-change-auto [.nav-open_&]:flex-[0_0_256px]" />
